...
public class DrawMiniMap {
	...
	public void render(Graphics2D g, Floor floor, DCoord positionHero, int screenWidth, int screenHeight) {
		...
		for(var r = 0; r<rows; r++) {
			for(var c = 0; c<cols; c++) {
				...
				if(floor.isWall(new DCoord(r, c))) {
